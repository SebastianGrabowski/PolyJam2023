...
public class GameController : MonoBehaviour
{
    ...
    private IEnumerator SpawnGods()
    {
        ...
        foreach(var god in availableGods)
        {
            ...
            var data = new GodData(god.Name, god.Description, god.TimeToUnlock, god.Sprite, god.CooldownFillSprite, god.EmptySprite, god.IdleGlowSprite, god.HoveredSprite, god.IconUI, god.AbillityType, god.Abillity, god.CooldownUIColor, god.Skills, god.RangeSprites);
